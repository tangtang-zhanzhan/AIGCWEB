...
const state = { route: routeFromLocation(), filter: '全部', theme: localStorage.getItem('portfolio-theme') || 'light', modal: null, menu: false, workflow: 'skill', workflowStep: 0, workflowRun: { mode: null, status: 'idle', step: -1, input: '', output: null }, workflowRunId: 0, workflowTimer: null, resumeAnswer: '', resumeOpen: false, model3d: false }
...
function bindEvents() {
  root.querySelectorAll('[data-3d]').forEach(el => el.addEventListener('click', () => { state.model3d = true; render() }))
